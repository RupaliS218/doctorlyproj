                    ...
                    <?php if($role == 'admin'): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a class="dropdown-item" href="<?php echo e(url('appointment/create')); ?>">
...
<?php /**PATH C:\xampp\htdocs\abhi\freelance\doctorly-master\resources\views/layouts/hor-menu.blade.php ENDPATH**/ ?>